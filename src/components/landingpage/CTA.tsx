  ...
  return (
    <div className="w-full bg-white pt-24 pb-32">
      <div className="container mx-auto px-8 max-w-4xl text-center">
        ...
        <button className="bg-dark-green hover:bg-black text-white px-8 py-3.5 rounded-full text-sm font-medium transition-colors shadow-[0_10px_20px_rgba(30,41,35,0.2)]">
          Contact Us
        </button>
